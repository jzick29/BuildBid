...
function IntegrationsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      ...
      <p className="text-gray-500 mb-6">Connect to builder platforms and accounting tools to sync your data.</p>
      ...
      <div className="mt-6 p-3 bg-gray-50 rounded-lg text-sm text-gray-500 dark:bg-gray-900 dark:text-gray-400">
        <strong>Tip:</strong> Connect builder platforms to pull bid invitations as draft estimates, and QuickBooks for invoice sync. Credentials are stored securely.
      </div>
    </div>
  );
}
